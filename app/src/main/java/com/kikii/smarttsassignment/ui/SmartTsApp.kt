...
import com.kikii.smarttsassignment.ui.navigation.Route
...
import com.kikii.smarttsassignment.ui.navigation.toSmartTsNavType
    ...
    Surface {
        SmartTsNavigationWrapper(
            ...
            SmartTsNavHost(
                ...
                navigationType = navSuiteType.toSmartTsNavType(),
            )
        }
    }}
    else{
